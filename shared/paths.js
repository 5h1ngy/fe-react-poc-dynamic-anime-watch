...
module.exports = {
  ...
  appEntryPackageComponents: resolveApp('src/packages/components'),
  appEntryPackageHocs: resolveApp('src/packages/hocs/'),
  appEntryPackageLayouts: resolveApp('src/packages/layouts/'),
